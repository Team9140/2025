package org.team9140.frc2025.limelight.undistort;

public class InterpolatingUndistortMap implements UndistortMap {
    final int pixelWidth_;
    final int pixelHeight_;
    final UndistortMap map_;

    public InterpolatingUndistortMap(int pixelWidth, int pixelHeight, UndistortMap map) {
